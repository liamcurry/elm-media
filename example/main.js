...
Elm.Media.make = function (_elm) {
   ...
   var toUrls = F2(function (site,media) {
      ...
      return {media: media
             ,url: site.url(media)
             ,imgSmUrl: A2($Maybe.andThen,site.imgSmUrl,url)
             ,imgMdUrl: A2($Maybe.andThen,site.imgMdUrl,url)
   ...
   var Listing = {ctor: "Listing"};
   var Album = {ctor: "Album"};
   var Image = {ctor: "Image"};
   var Video = {ctor: "Video"};
...
Elm.Media.Site.Gfycat = Elm.Media.Site.Gfycat || {};
Elm.Media.Site.Gfycat.make = function (_elm) {
   "use strict";
   _elm.Media = _elm.Media || {};
   _elm.Media.Site = _elm.Media.Site || {};
   _elm.Media.Site.Gfycat = _elm.Media.Site.Gfycat || {};
   if (_elm.Media.Site.Gfycat.values) return _elm.Media.Site.Gfycat.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var url = function (media) {
      var _p0 = media.kind;
      if (_p0.ctor === "Image") {
            return $Maybe.Just(A2($Basics._op["++"],"https://gfycat.com/",media.id));
         } else {
            return $Maybe.Nothing;
         }
   };
   var imgUrl = F2(function (size,media) {
      var _p1 = media.kind;
      if (_p1.ctor === "Image") {
            return $Maybe.Just(A2($Basics._op["++"],
            "https://",
            A2($Basics._op["++"],size,A2($Basics._op["++"],".gfycat.com/",A2($Basics._op["++"],media.id,".webm")))));
         } else {
            return $Maybe.Nothing;
         }
   });
   ...
   var site = {id: id
              ...
              ,matchers: matchers
              ,url: url
              ,imgSmUrl: $Maybe.Just(imgUrl("zippy"))
...
Elm.Media = Elm.Media || {};
Elm.Media.Site = Elm.Media.Site || {};
Elm.Media.Site.Imgur = Elm.Media.Site.Imgur || {};
Elm.Media.Site.Imgur.make = function (_elm) {
   "use strict";
   _elm.Media = _elm.Media || {};
   _elm.Media.Site = _elm.Media.Site || {};
   _elm.Media.Site.Imgur = _elm.Media.Site.Imgur || {};
   if (_elm.Media.Site.Imgur.values) return _elm.Media.Site.Imgur.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var url = function (media) {
      var _p0 = media.kind;
      switch (_p0.ctor)
      {case "Image": return $Maybe.Just(A2($Basics._op["++"],"https://imgur.com/",media.id));
         case "Album": return $Maybe.Just(A2($Basics._op["++"],"https://imgur.com/gallery/",media.id));
         default: return $Maybe.Nothing;}
   };
   var imgUrl = F2(function (size,media) {
      var _p1 = media.kind;
      switch (_p1.ctor)
      {case "Image": return $Maybe.Just(A2($Basics._op["++"],"https://i.imgur.com/",A2($Basics._op["++"],media.id,A2($Basics._op["++"],size,".jpg"))));
         case "Album": return $Maybe.Nothing;
         default: return $Maybe.Nothing;}
   });
   var imgSmUrl = imgUrl("t");
   var imgMdUrl = imgUrl("m");
   var imgLgUrl = imgUrl("l");
   var id = "imgur";
   var site = {id: id
              ,name: "Imgur"
              ,matchers: matchers
              ,url: url
              ,imgSmUrl: $Maybe.Just(imgSmUrl)
...
Elm.Media = Elm.Media || {};
Elm.Media.Site = Elm.Media.Site || {};
Elm.Media.Site.Livecap = Elm.Media.Site.Livecap || {};
Elm.Media.Site.Livecap.make = function (_elm) {
   "use strict";
   _elm.Media = _elm.Media || {};
   _elm.Media.Site = _elm.Media.Site || {};
   _elm.Media.Site.Livecap = _elm.Media.Site.Livecap || {};
   if (_elm.Media.Site.Livecap.values) return _elm.Media.Site.Livecap.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var iframeUrl = function (media) {
      var _p0 = media.kind;
      if (_p0.ctor === "Video") {
            return $Maybe.Just(A2($Basics._op["++"],"https://www.livecap.tv/s/embed/",media.id));
         } else {
            return $Maybe.Nothing;
         }
   };
   var url = function (media) {
      var _p1 = media.kind;
      if (_p1.ctor === "Video") {
            return $Maybe.Just(A2($Basics._op["++"],"https://www.livecap.tv/t/",media.id));
         } else {
            return $Maybe.Nothing;
         }
   };
...
Elm.Media = Elm.Media || {};
Elm.Media.Site = Elm.Media.Site || {};
Elm.Media.Site.Oddshot = Elm.Media.Site.Oddshot || {};
Elm.Media.Site.Oddshot.make = function (_elm) {
   "use strict";
   _elm.Media = _elm.Media || {};
   _elm.Media.Site = _elm.Media.Site || {};
   _elm.Media.Site.Oddshot = _elm.Media.Site.Oddshot || {};
   if (_elm.Media.Site.Oddshot.values) return _elm.Media.Site.Oddshot.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var iframeUrl = function (media) {
      var _p0 = media.kind;
      if (_p0.ctor === "Video") {
            return $Maybe.Just(A2($Basics._op["++"],"https://oddshot.tv/shot/",A2($Basics._op["++"],media.id,"/embed")));
         } else {
            return $Maybe.Nothing;
         }
   };
   var url = function (media) {
      var _p1 = media.kind;
      if (_p1.ctor === "Video") {
            return $Maybe.Just(A2($Basics._op["++"],"https://oddshot.tv/shot/",media.id));
         } else {
            return $Maybe.Nothing;
         }
   };
   ...
   var site = {id: id
              ...
              ,imgLgUrl: $Maybe.Nothing
              ,iframeUrl: $Maybe.Just(iframeUrl)};
   return _elm.Media.Site.Oddshot.values = {_op: _op,id: id,site: site};
};
Elm.Media = Elm.Media || {};
Elm.Media.Site = Elm.Media.Site || {};
Elm.Media.Site.Twitch = Elm.Media.Site.Twitch || {};
Elm.Media.Site.Twitch.make = function (_elm) {
   "use strict";
   _elm.Media = _elm.Media || {};
   _elm.Media.Site = _elm.Media.Site || {};
   _elm.Media.Site.Twitch = _elm.Media.Site.Twitch || {};
   if (_elm.Media.Site.Twitch.values) return _elm.Media.Site.Twitch.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var iframeUrl = function (media) {
      var _p0 = media.kind;
      switch (_p0.ctor)
      {case "Stream": return $Maybe.Just(A2($Basics._op["++"],"https://player.twitch.tv/?channel=",media.id));
         case "Video": return $Maybe.Just(A2($Basics._op["++"],"https://player.twitch.tv/?video=",media.id));
         default: return $Maybe.Nothing;}
   };
   var url = function (media) {
      var _p1 = media.kind;
      switch (_p1.ctor)
      {case "Stream": return $Maybe.Just(A2($Basics._op["++"],"https://www.twitch.tv/",media.id));
         case "Video": return $Maybe.Nothing;
         default: return $Maybe.Nothing;}
   };
   var imgUrl = F2(function (size,media) {
      var _p2 = media.kind;
      switch (_p2.ctor)
      {case "Stream": return $Maybe.Just(A2($Basics._op["++"],
           "https://static-cdn.jtvnw.net/previews-ttv/live_user_",
           A2($Basics._op["++"],media.id,A2($Basics._op["++"],"_-",A2($Basics._op["++"],size,".jpg")))));
         case "Video": return $Maybe.Nothing;
         default: return $Maybe.Nothing;}
   });
   var id = "twitch";
   var site = {id: id
              ...
              ,matchers: matchers
              ,url: url
              ,imgSmUrl: $Maybe.Just(imgUrl("80x45"))
...
Elm.Media = Elm.Media || {};
Elm.Media.Site = Elm.Media.Site || {};
Elm.Media.Site.YouTube = Elm.Media.Site.YouTube || {};
Elm.Media.Site.YouTube.make = function (_elm) {
   "use strict";
   _elm.Media = _elm.Media || {};
   _elm.Media.Site = _elm.Media.Site || {};
   _elm.Media.Site.YouTube = _elm.Media.Site.YouTube || {};
   if (_elm.Media.Site.YouTube.values) return _elm.Media.Site.YouTube.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var iframeUrl = function (media) {
      var _p0 = media.kind;
      if (_p0.ctor === "Video") {
            return $Maybe.Just(A2($Basics._op["++"],"https://www.youtube.com/embed/",media.id));
         } else {
            return $Maybe.Nothing;
         }
   };
   var url = function (media) {
      var _p1 = media.kind;
      if (_p1.ctor === "Video") {
            return $Maybe.Just(A2($Basics._op["++"],"https://www.youtube.com/watch?v=",media.id));
         } else {
            return $Maybe.Nothing;
         }
   };
   var imgUrl = F2(function (size,media) {
      ...
      if (_p2.ctor === "Video") {
            ...
            A2($Basics._op["++"],media.id,A2($Basics._op["++"],"/",A2($Basics._op["++"],size,".jpg")))));
         } else {
            return $Maybe.Nothing;
         }
   });
   ...
   var site = {id: id
              ...
              ,matchers: matchers
              ,url: url
              ,imgSmUrl: $Maybe.Just(imgUrl("default"))
...
Elm.Media = Elm.Media || {};
Elm.Media.Site = Elm.Media.Site || {};
Elm.Media.Site.make = function (_elm) {
   "use strict";
   _elm.Media = _elm.Media || {};
   _elm.Media.Site = _elm.Media.Site || {};
   if (_elm.Media.Site.values) return _elm.Media.Site.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Media$Site$Oddshot = Elm.Media.Site.Oddshot.make(_elm),
   $Media$Site$Twitch = Elm.Media.Site.Twitch.make(_elm),
   $Media$Site$YouTube = Elm.Media.Site.YouTube.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var video = _U.list([$Media$Site$Livecap.site,$Media$Site$Oddshot.site,$Media$Site$Twitch.site,$Media$Site$YouTube.site]);
   var image = _U.list([$Media$Site$Gfycat.site,$Media$Site$Imgur.site]);
   var all = $List.concat(_U.list([image,video]));
   return _elm.Media.Site.values = {_op: _op,image: image,video: video,all: all};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var toHtml = function (urls) {
      var iframeUrl = A2($Maybe.withDefault,"",urls.iframeUrl);
      var imgUrl = A2($Maybe.withDefault,"",$Maybe.oneOf(_U.list([urls.imgSmUrl,urls.imgMdUrl,urls.imgLgUrl])));
      return $Basics.not($String.isEmpty(iframeUrl)) ? A2($Html.iframe,
      _U.list([$Html$Attributes.src(iframeUrl)
              ,$Html$Attributes.$class("media-iframe")
      ...
      _U.list([])) : $Basics.not($String.isEmpty(imgUrl)) ? A2($Html.img,
      _U.list([$Html$Attributes.src(imgUrl),$Html$Attributes.$class("media-image")]),
      _U.list([])) : A2($Html.div,
      _U.list([$Html$Attributes.$class("media-none")]),
      _U.list([$Html.text("no image url"),$Html.text(urls.media.id),$Html.text(urls.media.siteId)]));
   };
   var html = function (results) {
      return A2($List.map,function (_p0) {    var _p1 = _p0;var _p2 = _p1._2;return {ctor: "_Tuple4",_0: _p1._0,_1: _p1._1,_2: _p2,_3: toHtml(_p2)};},results);
   };
   var update = F2(function (action,model) {    var _p3 = action;if (_p3.ctor === "NoOp") {    return model;} else {    return _p3._0;}});
   var kindToString = function (kind) {
      var _p4 = kind;
      switch (_p4.ctor)
   ...
   var ChangeText = function (a) {    return {ctor: "ChangeText",_0: a};};
   var view = F2(function (address,model) {
      var mediaView = function (_p5) {
         var _p6 = _p5;
         var _p8 = _p6._2;
         var _p7 = _p6._1;
         return A2($Html.div,
         ...
         _U.list([A2($Html.ul,
                 ...
                 _U.list([A2($Html.li,
                         _U.list([]),
                         _U.list([A2($Html.strong,_U.list([]),_U.list([$Html.text("Site: ")])),A2($Html.span,_U.list([]),_U.list([$Html.text(_p6._0.name)]))]))
                         ,A2($Html.li,
                         _U.list([]),
                         _U.list([A2($Html.strong,_U.list([]),_U.list([$Html.text("ID: ")])),A2($Html.span,_U.list([]),_U.list([$Html.text(_p7.id)]))]))
                         ,A2($Html.li,
                         _U.list([]),
      ...
      var input = A2($Html.div,
      _U.list([$Html$Attributes.$class("input")]),
      _U.list([A2($Html.textarea,
      _U.list([A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p9) {    return A2($Signal.message,address,ChangeText(_p9));})
